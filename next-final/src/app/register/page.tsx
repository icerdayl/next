...
const registerPage = () => {
    return(
        <>
            ...
            <form className="flex justify-center font-sans mt-10 mb-30">
                <div className="mt-2 flex-col bg-white text-black w-100 h-100 rounded-3xl text-center">
                    ...
                    <Link href="/login"><button type="submit" className="mt-2 bg-black text-white hover:font-bold cursor-pointer px-4 rounded-2xl">Enter</button></Link>
